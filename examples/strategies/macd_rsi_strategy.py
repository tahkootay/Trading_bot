...
class MacdRsiStrategy(StrategyBase):
    """
    MACD + RSI Strategy with EMA200 trend filter.
    
    Rules:
    - LONG: MACD line crosses signal line upward + RSI < 70 + Price > EMA200
    - SHORT: MACD line crosses signal line downward + RSI > 30 + Price < EMA200
    - TP: 0.7-1% fixed, SL: 0.5-0.7% fixed
    """
